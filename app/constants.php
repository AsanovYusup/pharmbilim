...
define('URL_USERS_REGION', PREFIX.'users/region');
define('URL_USERS_UNSORTED', PREFIX.'users/unsorted');
...
define('URL_USERS_ADD_LOCATION', PREFIX.'users/create/location');
define('URL_USERS_EDIT_LOCATION', PREFIX.'users/edit/location/');
define('URL_USERS_DELETE_LOCATION', PREFIX.'users/delete/location/');
define('URL_USERS_ADD_LOCATION_CREATE', PREFIX.'users/add/location');
define('URL_USERS_DELETE', PREFIX.'users/delete/');
define('URL_USERS_SETTINGS', PREFIX.'users/settings/');
define('URL_USERS_ADD_ATTEMPTS', PREFIX.'users/attempts/add/');
define('URL_USERS_ATTEMPTS', PREFIX.'users/attempts/');
define('URL_USERS_SETTINGS_LOCATION', PREFIX.'users/settings/location/');
...
define('URL_USERS_REGISTER_CONFIRM', PREFIX.'register/confirm');
...
define('URL_PARENT_CHILDREN_GETLIST_DETAILS', PREFIX.'users/details/getList/');
...
define('URL_EVENTS', PREFIX.'events');
define('URL_EVENTS_ADD', PREFIX.'events/add');
define('URL_EVENTS_EDIT', PREFIX.'events/edit/');
define('URL_EVENTS_UPDATE', PREFIX.'events/update/');
define('URL_EVENTS_DELETE', PREFIX.'events/delete/');
...
//TRAININGS QUESTIONS
define('URL_TRAININGS', PREFIX.'trainings');
define('URL_TRAININGS_ADD', PREFIX.'trainings/add');
define('URL_TRAININGS_EDIT', PREFIX.'trainings/edit/');
define('URL_TRAININGS_DELETE', PREFIX.'trainings/delete/');
define('URL_TRAININGS_GETLIST', PREFIX.'trainings/getList');

//PARTNERS QUESTIONS
define('URL_PARTNERS', PREFIX.'partners');
define('URL_PARTNERS_ADD', PREFIX.'partners/add');
define('URL_PARTNERS_EDIT', PREFIX.'partners/edit/');
define('URL_PARTNERS_DELETE', PREFIX.'partners/delete/');
define('URL_PARTNERS_GETLIST', PREFIX.'partners/getList');
