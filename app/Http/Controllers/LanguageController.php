    ...
    public function showme()
    {
    	if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
           $link_data = '<div class="dropdown more">
                          ...
                          <ul class="dropdown-menu" aria-labelledby="dLabel">
                            <li>
                              <a href="/languages/edit/'.$records->slug.'"><i class="fa fa-pencil"></i>'.getPhrase("edit").'</a>
                            </li>';
                            $temp = '';
         ...
         ->editColumn('is_default',function ($records)
        {
            ...
            return '<i class="fa fa-check text-success" title="'.getPhrase('enable').'"></i>';
            return '<a href="/languages/make-default/'.$records->slug.'" class="btn btn-xs btn-success waves-effect waves-themed">'.getPhrase('set_default').'</a>';
        })
        ->removeColumn('id')
        ->removeColumn('slug')
        ->make();
