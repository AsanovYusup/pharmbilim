...
class QuizController extends Controller
{
    ...
    public function getDatatable($slug = '')
    {
      ...
      if(!checkRole(getUserGrade(2)))
      {
          ...
          $link_data = '<div class="col text-center"><div class="btn-group">
                   ...
                   <i class="fal fa-cog"></i>
                        ...
                        <div class="dropdown-menu">
                           <a class="dropdown-item" href="'.URL_QUIZ_UPDATE_QUESTIONS.$records->slug.'"><i class="fal fa-spinner"></i> '.getPhrase("update_questions").'</a>
                            <a class="dropdown-item" href="'.URL_QUIZ_EDIT.'/'.$records->slug.'"><i class="fal fa-pencil"></i> '.getPhrase("edit").'</a>';
                            
                           $temp = '';
                           if(checkRole(getUserGrade(1))) {

                    $temp .= ' <a class="dropdown-item" href="javascript:void(0);" onclick="copy(\''.$records->slug.'\');"><i class="fal fa-copy"></i> '. getPhrase("copy").'</a>';

                    $temp .= ' <a class="dropdown-item" href="javascript:void(0);" onclick="deleteRecord(\''.$records->slug.'\');"><i class="fal fa-trash"></i> '. getPhrase("delete").'</a>';
                      }
        ...
        {
            return ($records->is_paid) ? '<span class="label label-danger">'.getPhrase('paid') .'</span>' : '<span class="label label-success">'.getPhrase('free').'</span>';
        })
