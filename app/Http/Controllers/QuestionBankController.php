            ...
            return '<div class="col text-center"><div class="btn-group">
                   ...
                   <i class="fal fa-cog"></i>
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a class="dropdown-item" href="'.URL_QUESTIONBANK_VIEW.$records->slug.'"><i class="fal fa-eye"></i> '.getPhrase("view_questions").'</a>

                            <a class="dropdown-item" href="'.URL_QUESTIONBANK_ADD_QUESTION.$records->slug.'"><i class="fal fa-plus-circle"></i> '.getPhrase("add").'</a>
                          </div>   
                        </div>
                    </div>';
            })
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
            return '<div class="col text-center"><div class="btn-group">
                       ...
                       <a class="dropdown-item" href="'.URL_QUESTIONBANK_EDIT_QUESTION.$records->slug.'"><i class="fal fa-pencil"></i> '.getPhrase("edit"). '</a>
                            
                       <a class="dropdown-item" href="javascript:void(0);" onclick="deleteRecord(\''.$records->slug.'\');"><i class="fal fa-trash"></i> '. getPhrase("delete"). '</a>
                        </div>
                        </div>
                    </div>';
            })
