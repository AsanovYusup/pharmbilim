...
class SubjectsController extends Controller
{
      ...
      if(!checkRole(getUserGrade(2)))
      {
        ...
        ->addColumn('action', function ($records) {
            ...
            $link_data = '<div class="col text-center"><div class="btn-group">
                            ...
                            <a class="dropdown-item" href="'.URL_SUBJECTS_EDIT.'/'.$records->slug.'"><i class="fal fa-pencil"></i> '.getPhrase("edit").'</a>';
                            $temp = '';
     ...
     catch(Exception $e)
     {
      ...
      DB::rollBack();
       if(getSetting('show_foreign_key_constraint','module'))
       {
          ...
          flash('Ошибка',$e->errorInfo, 'error');
       }
       else {
          flash('Ошибка','improper_data_in_the_question', 'error');
       }
     }
    ...
    public function store(Request $request)
    {
      ...
      try{
        ...
        DB::table('topics')->insert(['topic_name' => $topic_name, 'slug' => $slug,
        'parent_id' => 0, 'subject_id' => $subject_id, 'created_at' => $date, 'updated_at' => $date]);
       ...
       try {
          if(!env('DEMO_MODE')) {
           ...
           $record->delete();
            ...
            $response['status'] = 1;
            $response['message'] = getPhrase('Запись успешно удалена');
            }
