...
<head>
 ...
 <?php echo $__env->yieldContent('header_scripts'); ?>
		...
		<link href="<?php echo e(asset('Themes/themeone/assets/css/bootstrap.min.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('Themes/themeone/assets/css/sweetalert.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('Themes/themeone/assets/css/exam.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('Themes/themeone/assets/css/custom-fonts.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('Themes/themeone/assets/css/materialdesignicons.css')); ?>" rel="stylesheet">
		<link href="<?php echo e(asset('Themes/themeone/assets/font-awesome/css/font-awesome.min.css')); ?>" rel="stylesheet">

		<link href="<?php echo e(asset('Themes/themeone/assets/css/bootstrap-datepicker.min.css')); ?>" rel="stylesheet">

		<!-- Morris Charts CSS -->
		<link href="<?php echo e(asset('Themes/themeone/assets/css/plugins/morris.css')); ?>" rel="stylesheet">
...
if(isset($block_navigation))
 ...
 ?>
	...
	<script src="<?php echo e(asset('Themes/themeone/assets/js/jquery-1.12.1.min.js')); ?>"></script>
	<script src="<?php echo e(asset('Themes/themeone/assets/js/bootstrap.min.js')); ?>"></script>
	<script src="<?php echo e(asset('Themes/themeone/assets/js/main.js')); ?>"></script>
	<script src="<?php echo e(asset('Themes/themeone/assets/js/sweetalert-dev.js')); ?>"></script>
	<script src="<?php echo e(asset('Themes/themeone/assets/js/mousetrap.js')); ?>"></script>
