...
<div class="series-video text-center">
  ...
  <div class="plyr__video-embed" id="player" lms-slug="<?php echo e($content->slug); ?>" category="<?php echo e($series->slug); ?>">
...
<?php elseif($content->content_type=='iframe'): ?>
   ...
   <?php else: ?> 
      ...
      <iframe width="100%" height="560" class="video" src="<?php echo e($video_src); ?>?showinfo=0" frameborder="0" allowfullscreen>
      </iframe>
