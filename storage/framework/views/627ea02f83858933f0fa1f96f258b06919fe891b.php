	...
	<div class="page-wrapper">
		<div class="page-inner">
			...
			<aside class="page-sidebar">
				<div class="page-logo">
					<a href="<?php echo e(URL_HOME); ?>" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
						data-toggle="modal" data-target="#modal-shortcut">
						<img src="<?php echo e(IMAGE_PATH_SETTINGS.getSetting('site_logo', 'site_settings')); ?>"
							alt="<?php echo e(getSetting('site_title','site_settings')); ?>" aria-roledescription="logo">
				...
				<nav id="js-primary-nav" class="primary-nav" role="navigation">
					...
					<div class="info-card">
						<img src="<?php echo e(getProfilePath(Auth::user()->image, 'thumb')); ?>" class="profile-image rounded-circle"
					...
					<?php if(checkRole(getUserGrade(2))): ?>
						<?php echo $__env->make('layouts.nav.admin-nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>                           
					<?php else: ?>
						<?php echo $__env->make('layouts.nav.students-nav', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>                            
					<?php endif; ?>
