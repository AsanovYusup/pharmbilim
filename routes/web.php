...
// points
Route::post('points','StudentLmsController@points');
Route::post('update-timer','StudentLmsController@updateTimer');

// analisys
Route::get('/analysis/lms-points/{slug}','StudentLmsController@analysisLmsPoints');
Route::get('/analysis/all-points/{slug}','StudentLmsController@analysisAllPoints');
...
Route::post('register/confirm', 'Auth\RegisterController@postRegisterConfirm');
...
//add location 
Route::get('users/create/location', 'UsersController@createLocation');
Route::post('users/add/location', 'UsersController@addLocation');
Route::get('users/edit/location/{id}', 'UsersController@editLocation');
Route::delete('users/delete/location/{id}', 'UsersController@deleteLocation');
Route::patch('users/edit/location/{id}', 'UsersController@updateLocation');

//end location
Route::get('users/activate', 'UsersController@activate');
Route::post('users/activate', 'UsersController@confirmActivate');
Route::get('users/edit/{slug}', 'UsersController@edit');
Route::post('users/edit/{slug}', 'UsersController@update');
Route::get('users/profile/{slug}', 'UsersController@show');
Route::get('users', 'UsersController@index');
Route::get('users/export', 'UsersController@exportData');
Route::get('users/unsorted', 'UsersController@indexUnsorted');
Route::get('users/region', 'UsersController@region');
Route::get('users/region/details/{slug}', 'UsersController@regionDetails');
Route::get('users/company/details/{slug}', 'UsersController@companyDetails');
Route::get('users/company/details/alluser/{slug}', 'UsersController@userDetails');
Route::get('users/profile/{slug}', 'UsersController@show');
Route::get('users/details/{slug}', 'UsersController@details');
Route::get('users/details/getList/{slug}', 'UsersController@getDatatableDetails');

Route::get('users/settings/{slug}', 'UsersController@settings');
Route::patch('users/settings/{slug}', 'UsersController@updateSettings');

Route::get('users/attempts/{slug}', 'UsersController@settingsAttempts');
Route::get('users/attempts/add/{slug}/{user}', 'UsersController@addAttempts');
Route::patch('users/attempts/add/{slug}/{user}', 'UsersController@updateAttempts');

Route::get('users/settings/location/{slug}', 'UsersController@settingsLocation');
Route::patch('users/settings/location/{slug}', 'UsersController@updateSettingsLocation');
...
Route::get('users/copmany/getList/{role_name?}', [ 'as'   => 'users.dataTable.company',
    'uses' => 'UsersController@getDatatableCompany']);

Route::get('users/unsorted/getList/{role_name?}', [ 'as'   => 'users.dataTable.unsorted',
    'uses' => 'UsersController@getDatatableUnsorted']);
...
Route::get('parent/export/{slug}', 'ParentsController@exportData');
...
Route::get('events/add', 'UsersController@addEvents');
Route::post('events/add', 'UsersController@storeEvents');
Route::get('events/edit/{slug}', 'UsersController@editEvents');
Route::patch('events/update/{slug}', 'UsersController@updateEvents');
Route::delete('events/delete/{slug}', 'UsersController@deleteEvents');
//</editor-fold>

//<editor-fold desc="Trainings">
Route::get('trainings', 'SiteController@trainings');
Route::get('trainings/add', 'SiteController@addTrainings');
Route::post('trainings/add', 'SiteController@storeTrainings');
Route::get('trainings/edit/{slug}', 'SiteController@editTrainings');
Route::patch('trainings/update/{slug}', 'SiteController@updateTrainings');
Route::delete('trainings/delete/{slug}', 'SiteController@deleteTrainings');
//</editor-fold>

//<editor-fold desc="Partners">
Route::get('partners', 'SiteController@partners');
Route::get('partners/add', 'SiteController@addPartners');
Route::post('partners/add', 'SiteController@storePartners');
Route::get('partners/edit/{slug}', 'SiteController@editPartners');
Route::patch('partners/update/{slug}', 'SiteController@updatePartners');
Route::delete('partners/delete/{slug}', 'SiteController@deletePartners');
//</editor-fold>
...
Route::get('subscribed/ddata','UsersController@SubscribersData');
...
//User Verification
Route::post('user/confirmation','Auth\LoginController@confirmUser');
Route::get('user/confirmation','Auth\LoginController@confirmIndex');
