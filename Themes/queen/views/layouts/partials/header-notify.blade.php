								...
								<ul class="nav nav-tabs nav-tabs-clean" role="tablist">
									...
									<li class="nav-item">
										<a class="nav-link px-4 fs-md js-waves-on fw-500" data-toggle="tab" href="#tab-feeds"
											data-i18n="drpdwn.feeds">Подписки</a>
									</li>
									<li class="nav-item">
												...
												<li>
													<div class="d-flex align-items-center show-child-on-hover">
														<span class="d-flex flex-column flex-1">
															<span class="name d-flex align-items-center">Добавлен новый пользователь <span
																	class="badge badge-success fw-n ml-1">{{ getRoleData($user->role_id)}}</span></span>
