...
<html lang="ru">
    <head>
        ...
        <link rel="apple-touch-icon" sizes="180x180" href="{{themes('img/favicon/apple-touch-icon.png')}}">
        <link rel="icon" type="image/png" sizes="32x32" href="{{themes('img/favicon/favicon-32x32.png')}}">
                ...
                <div class="page-content-wrapper bg-transparent m-0">
                    <div class="height-10 w-100 shadow-lg px-4 bg-brand-gradient">
                        <div class="d-flex align-items-center container p-0">
                            ...
                            @if (Request::url() == URL_USERS_LOGIN)
                              <a href="{{URL_USERS_REGISTER}}" class="btn-link text-white ml-auto">
                                  {{getPhrase('Регистрация')}}
                              </a> 
                            @else
                               <a href="{{ URL_USERS_LOGIN }}" class="btn-link text-white ml-auto">
                                  {{getPhrase('Войти')}}
                               </a>
                            @endif
                    ...
                    <div class="flex-1" style="background: url({{themes('img/svg/pattern-1.svg')}}) no-repeat center bottom fixed; background-size: cover;">
                        <div class="container py-4 py-lg-5 my-lg-5 px-4 px-sm-0">
                            ...
                            <div class="position-absolute pos-bottom pos-left pos-right p-3 text-center text-white">
                                2020 © {{getSetting('site_title','site_settings')}} 
                            </div>
                        </div>
                    </div>
                </div>
