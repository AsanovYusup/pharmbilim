	...
	<div class="page-wrapper">
		<div class="page-inner">
			...
			<aside class="page-sidebar">
				<div class="page-logo">
					<a href="{{ URL_HOME }}" class="page-logo-link press-scale-down d-flex align-items-center position-relative"
						data-toggle="modal" data-target="#modal-shortcut">
						<img src="{{IMAGE_PATH_SETTINGS.getSetting('site_logo', 'site_settings')}}"
							alt="{{getSetting('site_title','site_settings')}}" aria-roledescription="logo">
				...
				<nav id="js-primary-nav" class="primary-nav" role="navigation">
					...
					<div class="info-card">
						<img src="{{ getProfilePath(Auth::user()->image, 'thumb') }}" class="profile-image rounded-circle"
							alt="{{Auth::user()->name}}">
					...
					@if(checkRole(getUserGrade(2)))
						@include('layouts.nav.admin-nav')                           
					@else
						@include('layouts.nav.students-nav')                            
					@endif
