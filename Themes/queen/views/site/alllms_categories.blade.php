        ...
        <div class="container">
            ...
            <div class="row cs-row">
                            ...
                            @endif
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" name="search_term"
                                        ...
                                        placeholder="{{getPhrase('search')}}" value="{{$search_term}}" onfocus="this.value=''"> <span class="input-group-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            ...
                            <ul class="cs-filter-bar clearfix">
                                ...
                                <li class="active"><a href="#">{{$title}} {{getPhrase('lms')}}</a></li>
                            ...
                            <ul class="cs-product-content mt-0">
                             ...
                             <li><a href="{{URL_VIEW_LMS_CONTENTS.$series->slug}}" class="cs-product-title">{{ucfirst($series->title)}}</a></li>
                               ...
                               <div class="text-center mt-2">
                                 ...
                                 <a href="{{URL_VIEW_LMS_CONTENTS.$series->slug}}" class=" btn btn-blue btn-sm btn-radius">{{getPhrase('view')}}</a>
                ...
                <div class="col-sm-9">
                    ...
                    <h4 class="text-center search-no">{{getPhrase('nothing_found')}}</h4>
