		...
		<div class="panel panel-custom col-lg-12">
			<div class="panel-heading">
				...
				<div class="pull-right messages-buttons">
					<a href="{{URL_USERS_REGION}}" class="btn  btn-primary button">{{ getPhrase('list')}}</a>
				</div>
				@endif
				<h1>{{ $title }}</h1>
			</div>
			...
			<div class="panel-body">
				...
				{{ Form::model($record,
						array('url' => URL_USERS_SETTINGS_LOCATION.$record->slug, 
				...
				<div class="row">
					...
					<div class="col-md-3">
						<label class="checkbox-inline">
							<input type="checkbox" data-toggle="toggle" name="quiz_categories[{{$category->id}}]"
								data-onstyle="success" data-offstyle="default" {{$checked}}> {{$category->category}}
						</label>
					</div>
					@endforeach
				</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						<label class="checkbox-inline">
							<input type="checkbox" data-toggle="toggle" data-onstyle="success" data-offstyle="default"
								name="lms_categories[{{$category->id}}]" {{$checked}}> {{$category->category}}
						</label>
					</div>
					@endforeach
				</div>
