					...
					<div class="card-header bg-white d-flex align-items-center">
							...
							<div class="ml-auto">
									<div class="btn-group btn-group-sm">										
											<a href="users/export" type="button" class="btn btn-primary waves-effect waves-themed">{{ getPhrase('export_excel')}}</a>
											<a href="{{URL_USERS_ADD}}" type="button" class="btn btn-primary waves-effect waves-themed">{{ getPhrase('add_user')}}</a>
									</div>
							</div>
					</div>					
...
@section('footer_scripts')
 ...
 @include('common.datatable-users-test', array('route'=>'users.dataTable.unsorted'))
