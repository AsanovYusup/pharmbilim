	...
	<div class="container-fluid">
		...
		<div class="panel panel-custom">
			<div class="panel-heading">
				<h1>{{getPhrase('result_for'). ' '.$title}}</h1>
			</div>
			...
			<div class="panel-body">
				...
				<div class="row">
					<div class="col-lg-12 text-center">
						<a onClick="setLocalItem('{{URL_RESULTS_VIEW_ANSWERS.$quiz->slug.'/'.$record->slug}}')"
							href="javascript:void(0);" class="btn t btn-primary">{{ getPhrase('view_key') }}</a>
					</div>
