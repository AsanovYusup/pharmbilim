...
{{--	   <link href="{{themes('css/bootstrap.min.css')}}" rel="stylesheet">--}}
	 ...
	 <link href="{{themes('css/jquery.datetimepicker.min.css')}}" rel="stylesheet">
...
{{--<div class="mywhatsappicon" id="mywhatsappicon"> <a href="https://wa.me/996505003744"><img src="{{IMAGES}}whatsapp.svg" width="50px" height="50px" alt=""></a></div>--}}
 ...
 ?>
	...
	<div id="wrapper" class="{{$class}}">
		...
		<aside class="left-sidebar">			<div class="collapse navbar-collapse navbar-ex1-collapse">				<ul class="nav navbar-nav side-nav">					<li {{ isActive($active_class, 'dashboard') }}> 
					...
					<a data-toggle="collapse" data-target="#users"><i class="fa fa-fw fa-users" ></i> 
					...
					<ul id="users" class="collapse sidemenu-dropdown">
							...
							<li><a href="{{URL_USERS}}"><i class="fa fa-fw fa-user-circle"></i> {{ getPhrase('users') }} </a> </li></li>

							<li><a href="{{URL_USERS_UNSORTED}}"> <i class="fa fa-fw fa-fw fa-user-times"></i>{{ getPhrase('users_unsorted') }}</a></li>

							<li><a href="{{URL_USERS_REGION}}"> <i class="fa fa-fw fa-fw fa-address-book"></i>{{ getPhrase('company_region_pharm') }}</a></li>
					...
					<a  href="{{URL_EVENTS}}"> <i class="fa fa-fw fa-calendar" aria-hidden="true"> </i>
					...
					<li {{ isActive($active_class, 'trainings') }} >
						...
						<a  href="/trainings"> <i class="fa fa-fw fa-calendar" aria-hidden="true"> </i>
					...
					<li {{ isActive($active_class, 'partners') }} >
						...
						<a  href="/partners"> <i class="fa fa-handshake-o" aria-hidden="true"> </i>
	...
	<script src="{{themes('js/main.js?v=2')}}"></script>
	...
	<script>
	 ...
	 <script>
	 	...
	 	function copy(argument) {
   			var dummyContent = 'http://pharmbilim.com/exams/student/quiz/take-exam/' + argument;
