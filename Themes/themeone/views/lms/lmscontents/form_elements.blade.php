 <?php $settings = getSettings('lms');?>
				...
				<div class="row">
 					 ...
 					 <fieldset class="form-group col-md-6">
						...
						{{ Form::text('title', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Заглавие',
					...
					<fieldset class="form-group col-md-6">
						...
						{{ Form::label('points', 'Очки') }}


						{{ Form::number('points', $value = null , $attributes = array('class'=>'form-control', 'placeholder' => 'Очки',
