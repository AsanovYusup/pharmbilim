 <!-- NAVIGATION -->
    ...
    <nav class="navbar navbar-default pw-navbar-default navbar-fixed-top" style="background-color: #f2f2f2;">

        <!-- /TOP BAR -->
    <div class="container">

                <div class="row topper-info">

                    <div class='topper bar topper-title col-sm-6'>онлайн обучение медицинских работников</div>

                    <div class='topper bar topper-title contact-topper col-sm-6'>контактный номер: <a href="tel:+996 505 00 37 44">+996 505 00 37 44</ a></div>
        ...
        <div class="cs-topbar">
            ...
            <div class="container">
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li><a href="{{PREFIX}}" class="cs-nav-btn cs-responsive-menu"><span>{{getPhrase('logout')}}</span><i class="icon icon-User " aria-hidden="true"></i></a></li>

                    @else

                    <li><a href="{{URL_USERS_REGISTER}}" class="cs-nav-btn visible-lg"> {{getPhrase('Зарегистрироваться')}}</a></li>

                    <li><a href="{{URL_USERS_LOGIN}}" class="cs-nav-btn cs-responsive-menu"><span>{{getPhrase('Войти')}}</span><i class="icon icon-User " aria-hidden="true"></i></a></li>
                ...
                <ul class="nav navbar-nav navbar-left navbar-main myheader">
                   ...
                   <!--  <li {{ isActive($active_class, 'login') }} ><a href="{{URL_USERS_LOGIN}}">{{getPhrase('Войти')}}</a></li> -->

                    <li {{ isActive($active_class, 'lms') }} ><a href="{{ URL_VIEW_ALL_LMS_CATEGORIES }}">Уроки</a></li>
