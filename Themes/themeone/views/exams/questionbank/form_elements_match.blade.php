...
<div ng-if="question_type=='match'">
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <input type="text" name="options_left[]" id="option_@{{ $index }}" class="form-control" placeholder="Вариант @{{ $index+1 }}" ng-model="answers.left.options[$index]"  required="true">
    </fieldset>
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <input type="text" name="options_right[]" id="option_@{{ $index }}" class="form-control" placeholder="Вариант @{{ $index+1 }}" ng-model="answers.right.options[$index]"  required="true">
    </fieldset>
 
    <fieldset class="form-group col-md-2" >
        <label >Ответ @{{ $index+1 }}</label> <span class="text-red">*</span>
...
<!--      <fieldset class="form-group col-md-5" >
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <label >{{getPhrase('left_option')}} @{{ $index+1 }} (2й язык)</label>
        <input type="text" name="optionsl2_left[]" id="optionl2_@{{ $index }}" class="form-control" placeholder="Вариант @{{ $index+1 }}" ng-model="answers.left.optionsl2[$index]"  >
    ...
    <fieldset class="form-group col-md-5" >
        ...
        <label >{{getPhrase('right_option')}} @{{ $index+1 }} (2й язык)</label>
        <input type="text" name="optionsl2_right[]" id="optionl2_@{{ $index }}" class="form-control" placeholder="Вариант @{{ $index+1 }}" ng-model="answers.right.optionsl2[$index]"  >
