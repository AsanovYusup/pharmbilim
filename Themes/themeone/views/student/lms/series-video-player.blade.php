...
<div class="series-video text-center">
  ...
  <div class="plyr__video-embed" id="player" lms-slug="{{$content->slug}}" category="{{$series->slug}}">
...
@elseif($content->content_type=='iframe')
   ...
   @else 
      ...
      <iframe width="100%" height="560" class="video" src="{{$video_src}}?showinfo=0" frameborder="0" allowfullscreen>
      </iframe>
