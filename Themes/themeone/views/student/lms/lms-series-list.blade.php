								...
								<div class="">
									...
									?>
										...
										<div class="buttons">
											...
											<a href="{{URL_STUDENT_LMS_SERIES_VIEW.$c->slug}}" class="btn btn-primary">{{getPhrase('view_lms')}}</a> 
									...
									<div class="item-details" style="text-align: center; font-size: 20px; font-weight: 700;">



										<a href="{{URL_STUDENT_LMS_SERIES_VIEW.$c->slug}}">{{ getPhrase('view_lms') }}</a>
