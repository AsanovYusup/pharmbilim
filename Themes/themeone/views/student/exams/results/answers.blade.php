            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-custom">
                    ...
                    <div class="panel-heading">
                        ...
                        <?php $status = getPhrase('pass'); ?>
                        @else 
                        <?php $status = getPhrase('fail'); ?>
                        @endif
                        <span class="result-pf-text">{{getPhrase('result').': '. $status}} </span>
                        <p><i class="fa fa-fw fa-check" style="color: #0fc32d;"></i>Правильные</p>
                        <p><i class="fa fa-fw fa-check" style="color: #c70000;"></i>Неправильные</p>
